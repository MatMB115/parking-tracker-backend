...
public record UserRequestDTO(Integer idUser, Integer idChild, String nome, String email, String senha, String contato, Character tipoUsuario, Integer creditos, Character turno) {
    public UserRequestDTO(Cliente cliente){
    ...
    public UserRequestDTO(Agente agente){
